...
public class Dictionary
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	//tests for directions, used after the computer understands that the player is trying to move.
	//////////////////////////////////////////////////////////////////////////////////////////////////
	public char getDirection(String d)
	{
		...
		else
		{
			...
			String str = d.substring(z + 1, d.length());//substring after the space to the end.
			for(int i = 0; i < north.length; i++)
			{
