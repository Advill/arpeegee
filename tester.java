...
public class tester
{
	...
	public static void main(String[] args)
	{
		...
		while(true) //in a loop because i want it to be sectioned off more or less
		{				//dosn't really need to be in one as the program does not make use of it.
			int pts = 30;
			int hp;
			int atk;
			int def;
			...
			//health
			System.out.println("You start with 100 Health, how much would you like to add? \nYou have " + pts + " points left.");
			while(true)
			{
				hp = in.nextInt();
				if(hp <= pts)
			...
			//attack
			System.out.println("You start with 25 attack, how much would you like to add? \nYou have " + pts + " points left.");
			while(true)
			{
				atk = in.nextInt();
				if(atk <= pts)
			...
			//defense
			System.out.println("You start with 25 defense, how much would you like to add? \nYou have " + pts + " points left.");
			while(true)
			{
				def = in.nextInt();
				if(def <= pts)
			...
			//speed
			System.out.println("You start with 25 Speed, how much would you like to add? \nYou have " + pts + " points left.");
			while(true)
			{
				spd = in.nextInt();
				if(spd <= pts)
			...
			System.out.println("So your name is " + name + ", You have " + (hp + 100) + " Health, " + (atk + 25) + " attack, " +(def + 25) + " defense, and " + (spd + 25) + " speed.");
			player = new Player(name, hp + 100, atk + 25, def + 25, spd + 25);
			break;
		}
		//////////////////////////////////////////////////////////////////////////////////////////////
		Map M = new Map();
		...
		//////////////////////////////////////////////////////////////////////////////////////////////
		//finite state machine, exit code is '0'
		//////////////////////////////////////////////////////////////////////////////////////////////
		while(true)
		{
			...
			player.heal(5);
			if(player.levelup())//if player has enough xp to level up
	...
	{
		System.out.println("You can go north, south, east, or west depending on where you are. Available directions should be printed above where you type.\n" +
	...
	public static void battle(Player P)
	{
		...
		do
		{
			...
			////////////////////////////////////
			//decides if the player did an action that the monster can attack after
			////////////////////////////////////
		...
		if(P.getHp() > 0 && S.getHp() <= 0)//player won/////
		{
			...
			int xp = (int)(Math.random() * 25) + 5;//generates random amount of experience between 5 and 25
	...
	public static void useItem(Player P)
	{
		...
		do
		{
			...
			if (next.equals("0"))	//0 exit code
				break;
			if(P.hasItem()) //tests if the player has any items at all, should probobly move this up.
			{
	...
	public static void levelup(Player P)//level ups// WIP///////////////////////////////////////////////////
	{
		if(P.levelup())
		{
			Scanner in = new Scanner(System.in);
